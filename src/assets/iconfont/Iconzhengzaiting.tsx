...
let Iconzhengzaiting: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconzhengzaiting.defaultProps = {
  size: 18,
};

Iconzhengzaiting = React.memo ? React.memo(Iconzhengzaiting) : Iconzhengzaiting;

export default Iconzhengzaiting;
